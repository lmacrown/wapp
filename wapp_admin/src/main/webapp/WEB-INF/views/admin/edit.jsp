                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/admin/editLecture.do?lecNo=${lecture.lecNo}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-xs-12">
                                        ...
                                        <input type="text" class="form-control file-upload-info" disabled=""
                                               placeholder="Upload Image" value="${lecimg}">
                                ...
                                <button class="btn btn-primary" onclick="location.href='admin/data-table.do'">취소
                                </button>
                            </form>
                        </div>
                    </div>
